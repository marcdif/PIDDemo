...
public class SetShotLowSpeed extends CommandBase {
  private final PIDShotUtil pidShotUtil;

  private boolean done;

  /** Creates a new SetShotLowSpeed. */
  public SetShotLowSpeed(PIDShotUtil pidShotUtil) {
  ...
  public void execute() {
    ...
    // Update the PID Controller's setpoint to Constants.shotLowRPM
    pidShotUtil.setSetpoint(Constants.shotLowRPM);
